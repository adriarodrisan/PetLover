...
<body>
    ...
    <section class="cat-list" id="cat-list">
        ...
        <div class="cat-card">
            ...
            <h4>Mami</h4>
            <p>Raza: Gato Angora | Fecha de nacimiento: 11/2024 | Tamaño: Mediano | Sexo: Hembra</p>
            <button>Saber más</button>
        </div>
        <div class="cat-card">
    ...
    <!-- Script para mostrar y cerrar fichas -->
    <script>
        ...
        // Añade eventos a cada botón "Saber más"
