...
<body>
    ...
    <p><strong>$nombre</strong>, con domicilio en [Dirección del Adoptante], identificado con [Tipo y Número de Documento], en adelante “el Adoptante”,</p>
    <p><strong>y</strong></p>
    <p><strong>[Nombre del Responsable de la Entrega]</strong>, con domicilio en [Dirección del Responsable], identificado con [Tipo y Número de Documento], en adelante “el Cedente”,</p>

    <p><strong>Se acuerda lo siguiente:</strong></p>

    <p class="section-title">PRIMERO: OBJETO DEL CONTRATO</p>
    <p>El Cedente entrega en adopción y el Adoptante acepta a [Nombre del Animal], un(a) [especie, raza], de aproximadamente [edad] años/meses, sexo [macho/hembra], en adelante “el Animal”.</p>
