...
<body>
    ...
    <section class="hero">
     ...
     <!-- Filtros para búsqueda de perros -->
...
<!-- Filtro por peso -->
    ...
    <section class="lista-perros" id="lista-perros">
        ...
        <!-- Tarjeta individual para cada perro -->
        <div class="tarjeta-perro">
...
<!-- Pie de página -->
    ...
    <!-- Script para mostrar y ocultar la ficha -->
    <script>
        ...
        // Asignar eventos a cada botón "Saber más"
